...
#define tc_generate_profile_forms_disp 0x120
...
#define tc_optimize_level_disp 0x124
...
#define tc_subset_mode_disp 0x128
#define tc_suppress_primitive_inlining_disp 0x12C
...
#define GENERATEPROFILEFORMS(x) (*((ptr *)((uptr)(x)+288)))
...
#define OPTIMIZELEVEL(x) (*((ptr *)((uptr)(x)+292)))
...
#define SUBSETMODE(x) (*((ptr *)((uptr)(x)+296)))
#define SUPPRESSPRIMITIVEINLINING(x) (*((ptr *)((uptr)(x)+300)))
